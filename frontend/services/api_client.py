...
def generate_pdf(analysis_data: Dict[str, Any], access_token: str = None) -> bytes:
    headers = _auth_headers(access_token) if access_token else {"Content-Type": "application/json"}
    response = requests.post(
