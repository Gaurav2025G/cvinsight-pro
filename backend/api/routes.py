...
async def generate_pdf(
    ...
    from backend.services.pdf_export import generate_pdf_from_analysis
    from fastapi.responses import Response

    try:
        pdf_bytes = generate_pdf_from_analysis(data.model_dump())
        return Response(
            content=pdf_bytes,
...
async def generate_history_pdf(
    ...
    try:
        from backend.services.pdf_export import generate_pdf_from_analysis
        from fastapi.responses import Response
        pdf_bytes = generate_pdf_from_analysis(analysis_data)
        return Response(
            content=pdf_bytes,
            media_type="application/pdf",
